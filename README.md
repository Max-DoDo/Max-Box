...
功能的小程序, 使用java17开发. 启动类放在项目文件中的src/MyMain.java里面
具体的使用方法详见 "功能" 部分. 大部分灵感来源于Microsoft公司开发的软件"Outlook"和"Todo"  
...
最推荐的联系方式:  
* 发送邮件到:<great_maxwell@outlook.com> 并且礼貌的构思标题和正文, 说明你的信息和来意

一般推荐的联系方式:
* QQ: 1172558575
* 微信: maxwell_java  
并且在好友申请中提到例如: 我是天道酬勤. 让我困扰究竟是你是看了我的屎山来吐槽我的技术, 还是我又沾花惹草了, 谁人的父母来兴师问罪了.
